...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		TexturedModel castel = new TexturedModel(OBJFileLoader.loadOBJ("hogwarts4", loader),
				new ModelTexture(loader.loadTexture("crate")));

		

		Terrain terrain1 = new Terrain(0, -1, loader, texturePack, blendMap, "hm01");
		Terrain terrain2 = new Terrain(-1, -1, loader, texturePack, blendMap, "hm02");
		Terrain terrain3 = new Terrain(-1, 0, loader, texturePack, blendMap, "hm02");
		Terrain terrain4 = new Terrain(0, 0, loader, texturePack, blendMap, "hm01");
		...
		entities.add(new Entity(castel, new Vector3f(0,0,-400), 0, 0, 0, 2.0f));
